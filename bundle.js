...
$(document).ready(function(){
    ...
    $('#submit-btn').on("click", function() {
        ...
        $.get(urlFut, function(response) {
            ...
            $('#predicted-description1').append("<img src='http://openweathermap.org/img/wn/" + response.list[0].weather[0].icon + "@2x.png'>" + response.list[0].weather[0].description)
            $('#predicted-feels1').append('Feels like: '+ Math.round(response.list[0].main.feels_like) + '&deg;F')
            $('#predicted-low1').append('Low: '+ Math.round(response.list[0].main.temp_min) + '&deg;F')
            $('#predicted-high1').append('High: ' + Math.round(response.list[0].main.temp_max) + '&deg;F')
            $('#predicted-pressure1').append('Pressure: ' + Math.round(response.list[0].main.pressure) + ' PSI')
            $('#predicted-humid1').append('Humidity: ' + Math.round(response.list[0].main.humidity) + '&#37;')
        })
